...
runtime_create :: proc(
	...
	runtime^ = {descriptor = descriptor, backend = backend, width = width, height = height, initialized = true}
	return true
}
...
runtime_update_texture_rgba :: proc(runtime: ^Runtime, texture: Texture, pixels: []u8) -> bool {
	...
	return runtime.backend.update_texture_rgba != nil &&
...
runtime_request_screenshot :: proc(runtime: ^Runtime, path: string) -> bool {
	return runtime.initialized && path != "" && runtime.backend.request_screenshot != nil &&
