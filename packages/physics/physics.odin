...
add_box :: proc(
	...
	return zelda_physics_body_add_box(
		world,
		&extent_value,
		&position_value,
		&rotation_value,
...
add_sphere :: proc(
	...
	return zelda_physics_body_add_sphere(
		world,
		radius,
		&position_value,
		&rotation_value,
...
update_height_field :: proc(
	...
	return zelda_physics_height_field_set_heights(
		world,
		body,
		x,
		y,
...
create_vehicle :: proc(
	...
	return zelda_physics_vehicle_create(
		world,
		&settings_value,
		&position_value,
		&rotation_value,
...
destroy_vehicle :: proc(world: World, vehicle: Vehicle) {zelda_physics_vehicle_destroy(
		world,
		vehicle,
	)}
set_vehicle_input :: proc(
	world: World,
	vehicle: Vehicle,
	forward, steering, brake, handbrake: f32,
) {
...
set_vehicle_transform :: proc(
	...
	position_value, rotation_value := position, rotation
	zelda_physics_vehicle_set_transform(
		world,
		vehicle,
		&position_value,
		&rotation_value,
